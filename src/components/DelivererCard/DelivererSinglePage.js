    ...
    <div className='deliverer'>
      <div className='deliverer__sidebar'>
        <div className='deliverer__sidebar-profile'>
          <div
            className={`deliverer__sidebar-status ${
              status === 'Вільний' ? 'green' : 'red'
            }`}
          >
            {status}
          </div>
          ...
          <div className='deliverer__sidebar-name'>{name}</div>

          <div className='deliverer__sidebar-specialization'>
            <p>
              Cпеціалізація: <span>{specialization}</span>
            </p>
          </div>

          <div className='deliverer__sidebar-description'>{description}</div>
        </div>
          ...
          <div className='location'>
            ...
            >
              <g clip-path='url(#clip0_420_128764)'>
                <path
                  d='M14 6.66601C14 11.3327 8 15.3327 8 15.3327C8 15.3327 2 11.3327 2 6.66601C2 5.07472 2.63214 3.54859 3.75736 2.42337C4.88258 1.29816 6.4087 0.666016 8 0.666016C9.5913 0.666016 11.1174 1.29816 12.2426 2.42337C13.3679 3.54859 14 5.07472 14 6.66601Z'
                  stroke='#2B2B2A'
                  stroke-width='1.5'
                  stroke-linecap='round'
                  stroke-linejoin='round'
        ...
        <div className='deliverer__sidebar-mastery'>
          <div className='experience'>
            <h3>Досвід</h3>
            <p>
              Досвід: <span>5 років</span>
            </p>
            <p>
              {' '}
              Заходив: <span>25 хвилин тому</span>
            </p>
          </div>
          <div className='divider'></div>
      ...
      <div className='deliverer__main'>
            ...
            <div className='propositions__item'>
              ...
              >
                <g clip-path='url(#clip0_517_128820)'>
                  ...
                  />
                  <path
                    d='M20.1667 3.66667L11 12.8425L8.25 10.0925'
                    stroke='#3470FF'
                    stroke-width='1.8'
                    stroke-linecap='round'
                    stroke-linejoin='round'
        ...
        <div className='deliverer__services'>{accordionElements}</div>
      </div>
    </div>
  )
}
