...
const BlogSinglePage = ({ img, title, author, description, tags, article }) => {
  return (
    <div className='single-blog'>
      <div className='single-blog__date'>{author}</div>

      <div className='single-blog__title'>
        <span>{title}</span>
      </div>

      <div className='single-blog__description'>{description}</div>
