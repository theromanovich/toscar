      ...
      <div className='benefits__container'>
        ...
        <div className='benefits__wrapper'>
          ...
          <div className='benefits__item'>
            ...
            <div className='descr'>
              Омріяне авто зі США прямо під двері. Вам лише залишається отримати
              його у зручний для вас спосіб
            </div>
          </div>
          <div className='benefits__item'>
            <div className='icon'>
            ...
            <div className='descr'>
              Повний супровід у світі автомобілів - ваш персональний менеджер з
              пригону авто зі США
            </div>
          </div>
          <div className='benefits__item'>
            ...
            <div className='descr'>
              Повний контроль над процесом пригону авто зі США завдяки нашому
